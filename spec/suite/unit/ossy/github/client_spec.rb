...
RSpec.describe Ossy::Github::Client do
  ...
  describe "#membership?" do
    it "returns true if a given user has active membership", vcr: true,
                                                             cassette: "gh-membership-no" do
  ...
  describe "#tagger" do
    ...
    it "returns tagger and verification status set to false", vcr: true,
                                                              cassette: "gh-tag-not-signed" do
